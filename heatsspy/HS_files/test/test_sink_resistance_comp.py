...
class test_fin_resistance_comp(unittest.TestCase):


    def setUp(self):

        self.prob = om.Problem()
        self.prob.model.add_subsystem('resistance', FinResistanceComp(num_nodes=1))
    ...
    def test_case1(self):
        ...
        self.prob.set_val('resistance.Pm', 0.102, units='m')
        ...
        self.prob.set_val('resistance.Ht', 8, units='mm')

        self.prob.run_model()

        assert_near_equal(self.prob['resistance.R_th_fins'], 2.94, tol)
