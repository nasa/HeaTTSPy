...
if __name__ == "__main__":
    ...
    print('Sp =',prob.get_val('heat_sink.h_calc.Sp', units='mm'))
    print('Vch =',prob.get_val('heat_sink.Vch', units='m/s'))
    print('Pin =',prob.get_val('heat_sink.Fl_I:tot:P', units='Pa'))
    print('dP =',prob.get_val('heat_sink.dP', units='Pa'))
    # A = prob.get_val('heat_sink.Fl_I:tot:P', units='Pa') - prob.get_val('heat_sink.Fl_O:tot:P', units='Pa')
    # print('dP =', A)
