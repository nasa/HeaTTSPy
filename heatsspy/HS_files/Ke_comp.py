...
class Ke_calc(ExplicitComponent):
    ''' Define expansion loss coefficient'''
    def initialize(self):
...
if __name__ == "__main__":
    ...
    Blk = prob.model.add_subsystem('Ke_calc',Ke_calc(num_nodes=1),
        promotes_inputs=['*'])
    ...
    print('Ke ='+str(prob['Ke_calc.Ke'][0]))
