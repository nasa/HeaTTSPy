...
class enthalpy_calc(ExplicitComponent):
...
if __name__ == "__main__":
    ...
    Blk = prob.model.add_subsystem('prop_calc', enthalpy_calc(num_nodes=2),
        promotes_inputs=['*'])
    prob.model.add_subsystem('prop_calc1', enthalpy_calc(num_nodes=2,dim=1),
        promotes_inputs=[('*')])
