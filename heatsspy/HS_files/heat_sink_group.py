...
if __name__ == "__main__":
    ...
    for h_calc_method in ['nellis', 'teerstra']:
        ...
        prob.set_val('W', val=0.0029400000000000003, units='kg/s')
        prob.set_val('T', val=20, units='degC')
        #prob.set_val('T', val=(350-273.15), units='degC')
        prob.set_val('P', val=101.325, units='kPa')
        prob.set_val('heat_sink.Ht', val=0.020, units='m' )
        prob.set_val('heat_sink.Wth', val=0.008, units='m')
        prob.set_val('heat_sink.Lng', val=0.025, units='m')
        prob.set_val('heat_sink.t_fin', val=.0005, units='m')
